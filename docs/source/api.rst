...
registers. It inherits from two mixins:
:class:`~tmodbus.pdu.holding_registers_struct.HoldingRegisterReadMixin` and
:class:`~tmodbus.pdu.holding_registers_struct.HoldingRegisterWriteMixin`, which provide
additional methods for reading and writing structured data from/to holding registers.
