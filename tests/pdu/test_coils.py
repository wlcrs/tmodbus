...
class TestReadCoilsPDU:
    ...
    def test_read_coils_address_validation(self):
    ...
    def test_read_coils_quantity_validation(self):
    ...
    def test_read_coils_encode_request(self):
    ...
    def test_read_coils_decode_response(self):
    ...
    def test_read_coils_invalid_response(self):
    ...
    def test_decode_request_struct_error(self):
    ...
    def test_encode_response_multiple_bytes(self):
    ...
    def test_encode_response_partial_byte(self):
...
class TestWriteSingleCoilPDU:
    ...
    def test_write_single_coil_pdu(self):
    ...
    def test_write_single_coil_decode_response(self):
    ...
    def test_decode_request_valid_on(self):
    ...
    def test_decode_request_valid_off(self):
...
class TestWriteMultipleCoilsPDU:
    ...
    def test_write_multiple_coils_validation(self):
    ...
    def test_write_multiple_coils_decode_response(self, response: bytearray, address: int, value_count: int):
    ...
    def test_decode_request_valid_single_byte(self):
    ...
    def test_decode_request_valid_multiple_bytes(self):
    ...
    def test_decode_request_too_short_for_struct(self):
    ...
    def test_decode_request_invalid_quantity_too_high(self):
        """Test decode_request with quantity too high."""
        request = struct.pack(">BHHB", 0x0F, 100, 1969, 247) + b"\x00" * 247
        with pytest.raises(InvalidRequestError, match=r"Number of coils must be between 1 and 1968\."):
            WriteMultipleCoilsPDU.decode_request(request)

    def test_decode_request_invalid_length(self):
    ...
    def test_decode_request_invalid_byte_count(self):
